 ...
 */
public enum TrainDBProperty
{
    /**
     * Database name to connect to (may be specified directly in the JDBC URL)
     */
    TRAINDB_DBNAME("TrainDBNAME", null, "Database name to connect to (may be specified directly in the JDBC URL)", true),

    /**
     * Hostname of the PostgreSQL server (may be specified directly in the JDBC URL)
     */
    TRAINDB_HOST("TrainDBHOST", null, "Hostname of the TrainDB server (may be specified directly in the JDBC URL)", false),

    /**
     * Port of the PostgreSQL server (may be specified directly in the JDBC URL)
     */
    TRAINDB_PORT("TrainDBPORT", null, "Port of the PostgreSQL server (may be specified directly in the JDBC URL)"),
    ...
    */
    ...
    private TrainDBProperty(String name, String defaultValue, String description)
    {
        this(name, defaultValue, description, false);
    }

    private TrainDBProperty(String name, String defaultValue, String description, boolean required)
    {
        this(name, defaultValue, description, required, (String[]) null);
    }
    
    private TrainDBProperty(String name, String defaultValue, String description, boolean required, String... choices)
    {
        _name = name;
    ...
    public static TrainDBProperty forName(String name)
    {
        for (TrainDBProperty property : TrainDBProperty.values())
        {
