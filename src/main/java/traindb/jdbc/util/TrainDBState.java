...
public class TrainDBState implements Serializable{
    ...
    public final static TrainDBState CONNECTION_FAILURE_DURING_TRANSACTION = new TrainDBState("08007");
    ...
    public final static TrainDBState STATEMENT_NOT_ALLOWED_IN_FUNCTION_CALL = new TrainDBState("2F003");
