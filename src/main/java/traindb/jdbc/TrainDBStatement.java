...
public class TrainDBStatement implements Statement {
	...
	public TrainDBStatement(TrainDBConnection trainDBConnection, int resultSetType, int resultSetConcurrency, int resultSetHoldability) {
	...
	public class StatementResultHandler {
	    ...
	    public void handleResultRows(String fromQuery, Field[] fields, List<Tuple> tuples, @Nullable ResultCursor cursor) {
	    	try {
	...
	public ResultSet createResultSet(String originalQuery, Field[] fields, List<Tuple> tuples, @Nullable ResultCursor cursor) throws SQLException {
		TrainDBResultSet newResult = new TrainDBResultSet(originalQuery, this, fields, tuples, cursor, getMaxRows(), getMaxFieldSize(), getResultSetType(), getResultSetConcurrency(), getResultSetHoldability(), getAdaptiveFetch());
