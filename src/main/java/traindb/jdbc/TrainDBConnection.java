...
public class TrainDBConnection implements Connection {
	...
	public Statement createStatement(int resultSetType, int resultSetConcurrency, int resultSetHoldability) throws SQLException {
		checkClosed();
	    return new TrainDBStatement(this, resultSetType, resultSetConcurrency, resultSetHoldability);
	}
	...
	public PreparedStatement prepareStatement(String sql, int resultSetType, int resultSetConcurrency, int resultSetHoldability) throws SQLException {
		...
		return new TrainDBPreparedStatement(this, sql, resultSetType, resultSetConcurrency, resultSetHoldability);
	}
	...
	protected void checkClosed() throws SQLException {
		if (isClosed()) {
			throw new TrainDBException(GT.tr("This connection has been closed."), TrainDBState.CONNECTION_DOES_NOT_EXIST);
		}
	}
}
