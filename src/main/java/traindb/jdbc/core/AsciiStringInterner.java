...
final class AsciiStringInterner {
   ...
   */
  public String getString(byte[] bytes, int offset, int length, Encoding encoding)
      throws IOException {
    if (length == 0) {
      return "";
    }
   ...
   * @throws IOException If error decoding from <i>Encoding</i>.
   */
  public String getStringIfPresent(byte[] bytes, int offset, int length, Encoding encoding)
      throws IOException {
    if (length == 0) {
      return "";
    }
