...
public class Encoding {
  ...
  /**
   * Subclasses may use this constructor if they know in advance of their ASCII
   * number compatibility.
   *
   * @param encoding         charset to use
   * @param fastASCIINumbers whether this encoding is compatible with ASCII
   *                         numbers.
   */
  ...
  /**
   * Use the charset passed as parameter and tests at creation time whether the
   * specified encoding is compatible with ASCII numbers.
   *
   * @param encoding charset to use
   */
   ...
   * @return an Encoding instance for the specified encoding, or an Encoding
   * instance for the default JVM encoding if the specified encoding is
   * unavailable.
   */
  ...
  public static Encoding getDatabaseEncoding(String databaseEncoding) {
    ...
    LOGGER.log(Level.FINEST, "{0} encoding not found, returning default encoding",
        databaseEncoding);
    return DEFAULT_ENCODING;
  }
  ...
  /**
   * Checks whether this encoding is compatible with ASCII for the number
  ...
  /**
   * Returns true if this encoding has characters '-' and '0'..'9' in exactly same
   * posision as ascii.
   *
   ...
   * @throws IOException if something goes wrong
   */
  public String decodeCanonicalized(byte[] encodedString, int offset, int length)
      throws IOException {
    if (length == 0) {
      return "";
    }
   ...
   *
   * @param encodedString a byte array containing the string to decode
   * @param offset        the offset in <code>encodedString</code> of the first
   *                      byte of the encoded representation
   * @param length        the length, in bytes, of the encoded representation
   * @return the decoded string
   * @throws IOException if something goes wrong
   */
