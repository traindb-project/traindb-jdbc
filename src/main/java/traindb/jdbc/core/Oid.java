...
public class Oid {
	 ...
	 * @return The name of the oid or {@code "<unknown>"} if oid no constant for oid
	...
	public static int valueOf(String oid) throws TrainDBException {
		...
		throw new TrainDBException(GT.tr("oid type {0} not known and not a number", oid), TrainDBState.INVALID_PARAMETER_VALUE);
	}
}