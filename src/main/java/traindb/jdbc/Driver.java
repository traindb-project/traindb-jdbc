...
public final class Driver implements java.sql.Driver {
  ...
  public static SQLFeatureNotSupportedException notImplemented(Class callClass,
    ...
    return new SQLFeatureNotSupportedException(
        MessageFormat.format("Method {0} is not yet implemented.",
            callClass.getName() + "." + functionName), TrainDBState.NOT_IMPLEMENTED.getState());
  }
  ...
  public Connection connect(String url, Properties info) throws SQLException {
    ...
    try {
      ...
      throw new TrainDBJdbcException("Error loading default settings from driverconfig.properties",
          TrainDBState.UNEXPECTED_ERROR, ioe);
    }
    ...
    try {
      ...
      throw new TrainDBJdbcException(
          ...
          TrainDBState.UNEXPECTED_ERROR, ace);
    } catch (Exception ex2) {
      logger.debug("Unexpected connection error:", ex2);
      throw new TrainDBJdbcException(
          "Something unusual has occurred to cause the driver to fail. Please report this exception.",
          TrainDBState.UNEXPECTED_ERROR, ex2);
    }
  }
        ...
        while (true) {
          ...
          if (resultException != null) {
            if (resultException instanceof SQLException) {
              ...
              throw new TrainDBJdbcException(
                  "Something unusual has occurred to cause the driver to fail. Please report this exception.",
                  TrainDBState.UNEXPECTED_ERROR, resultException);
            }
          }
          ...
          if (delay <= 0) {
            abandoned = true;
            throw new TrainDBJdbcException("Connection attempt timed out.",
                TrainDBState.CONNECTION_UNABLE_TO_CONNECT);
          }
